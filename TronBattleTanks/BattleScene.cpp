...
void BattleScene::AddWorldColliders(Scene* const pScene)
{
	...
	pScene->Add(std::move(pRightWall));
	...
	pScene->Add(std::move(pBottomWall));
	...
	pScene->Add(std::move(pMediumCollider1));
	...
	pScene->Add(std::move(pMediumCollider2));
	...
	pScene->Add(std::move(pMediumCollider3));
	...
	pScene->Add(std::move(pMediumCollider4));
	...
	pScene->Add(std::move(pMediumCollider5));
	...
	pScene->Add(std::move(pMediumCollider6));
	...
	pScene->Add(std::move(pMediumCollider7));
	...
	pScene->Add(std::move(pMediumCollider8));
	...
	pScene->Add(std::move(pMediumCollider9));
	...
	pScene->Add(std::move(pMediumCollider10));
	...
	pScene->Add(std::move(pMediumCollider11));
	...
	pScene->Add(std::move(pMediumCollider12));
	...
	pScene->Add(std::move(pMediumCollider13));
	...
	pScene->Add(std::move(pMediumCollider14));
	...
	pScene->Add(std::move(pMediumCollider15));
	...
	pScene->Add(std::move(pMediumCollider16));
	...
	pScene->Add(std::move(pMediumCollider17));
	...
	pScene->Add(std::move(pMediumCollider18));
	...
	pScene->Add(std::move(pMediumCollider19));
	...
	pScene->Add(std::move(pMediumCollider20));
	...
	pScene->Add(std::move(pMediumCollider21));
	...
	pScene->Add(std::move(pMediumCollider22));
	...
	pScene->Add(std::move(pMediumCollider23));
	...
	pScene->Add(std::move(pMediumCollider24));
	...
	pScene->Add(std::move(pMediumCollider25));
	...
	pScene->Add(std::move(pMediumCollider26));
	...
	pScene->Add(std::move(pMediumCollider27));
	...
	pScene->Add(std::move(pMediumCollider28));
	...
	pScene->Add(std::move(pMediumCollider29));
	...
	pScene->Add(std::move(pSmallCollider1));
	...
	pScene->Add(std::move(pSmallCollider2));
	...
	pScene->Add(std::move(pSmallCollider3));
	...
	pScene->Add(std::move(pSmallCollider4));
	...
	pScene->Add(std::move(pSmallCollider5));
	...
	pScene->Add(std::move(pSmallCollider6));
	...
	pScene->Add(std::move(pSmallCollider7));
	...
	pScene->Add(std::move(pSmallCollider8));
	...
	pScene->Add(std::move(pSmallCollider9));
	...
	pScene->Add(std::move(pSmallCollider10));
	...
	pScene->Add(std::move(pSmallCollider11));
	...
	pScene->Add(std::move(pSmallCollider12));
	...
	pScene->Add(std::move(pSmallCollider13));
	...
	pScene->Add(std::move(pSmallCollider14));
	...
	pScene->Add(std::move(pSmallCollider15));
	...
	pScene->Add(std::move(pSmallCollider16));
	...
	pScene->Add(std::move(pSmallCollider17));
	...
	pScene->Add(std::move(pSmallCollider18));
	...
	pScene->Add(std::move(pSmallCollider19));
	...
	pScene->Add(std::move(pSmallCollider20));
	...
	pScene->Add(std::move(pSmallCollider21));
	...
	pScene->Add(std::move(pSmallCollider22));
	...
	pScene->Add(std::move(pSmallCollider23));
}
